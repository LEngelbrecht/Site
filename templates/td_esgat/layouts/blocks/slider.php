...
$jukenburn_thumb8 	= $this->params->get('jukenburn_thumb8', '' );
...
$jukenburn_image7 	= $this->params->get('jukenburn_image7', '' );
$jukenburn_image8 	= $this->params->get('jukenburn_image8', '' );
...
$jukenburn_texts7 	= $this->params->get('jukenburn_texts7', '' );
$jukenburn_texts8 	= $this->params->get('jukenburn_texts8', '' );
...
$jukenburn_text7 	= $this->params->get('jukenburn_text7', '' );
$jukenburn_text8 	= $this->params->get('jukenburn_text8', '' );
...
$jukenburn_desc7 	= $this->params->get('jukenburn_desc7', '' );
$jukenburn_desc8 	= $this->params->get('jukenburn_desc8', '' );
...
<li data-transition="fade" data-slotamount="4" > <img src="<?php echo $jukenburn_thumb2; ?>">
...
<li data-transition="fade" data-slotamount="4" > <img src="<?php echo $jukenburn_thumb3; ?>">
...
<li data-transition="fade" data-slotamount="4"> <img src="<?php echo $jukenburn_thumb4; ?>">
...
<li data-transition="fade" data-slotamount="4"> <img src="<?php echo $jukenburn_thumb5; ?>">
...
<li data-transition="fade" data-slotamount="4"> <img src="<?php echo $jukenburn_thumb6; ?>">
...
<?php endif;?>
<?php if ($jukenburn_thumb7): ?>
<li data-transition="fade" data-slotamount="4"> <img src="<?php echo $jukenburn_thumb7; ?>">
<div class="tp-caption sft very_big_white"  data-x="100" data-y="210" data-speed="600" data-start="700" data-easing="easeOutBack"><?php echo $jukenburn_texts7; ?></div>
<div class="tp-caption sfl big_black" data-x="-30" data-y="285" data-speed="700" data-start="1500" data-easing="easeOutExpo"><?php echo $jukenburn_desc7; ?></div>
<?php if ($jukenburn_text7): ?><div class="tp-caption sfl buttons"  data-x="-30" data-y="230" data-speed="400" data-start="2400" data-easing="easeOutBack"><a href="<?php echo $jukenburn_text7; ?>" title="<?php echo $jukenburn_text7; ?>">Read more</a></div><?php endif;?>
</li>
<?php endif;?>
<?php if ($jukenburn_thumb8): ?>
<li data-transition="fade" data-slotamount="4"> <img src="<?php echo $jukenburn_thumb8; ?>">
<div class="tp-caption sft very_big_white"  data-x="100" data-y="210" data-speed="600" data-start="700" data-easing="easeOutBack"><?php echo $jukenburn_texts8; ?></div>
<div class="tp-caption sfl big_black" data-x="-30" data-y="285" data-speed="700" data-start="1500" data-easing="easeOutExpo"><?php echo $jukenburn_desc8; ?></div>
<?php if ($jukenburn_text8): ?><div class="tp-caption sfl buttons"  data-x="-30" data-y="230" data-speed="400" data-start="2400" data-easing="easeOutBack"><a href="<?php echo $jukenburn_text8; ?>" title="<?php echo $jukenburn_text8; ?>">Read more</a></div><?php endif;?>
</li>
<?php endif;?>
</ul>
