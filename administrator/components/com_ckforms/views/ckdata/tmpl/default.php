...
<?php 
	$sortLink = JRoute::_( 'index.php?option=com_ckforms&controller=ckdata&fid='.JRequest::getVar( 'fid', -1 ).'&limitstart='.JRequest::getVar( 'limitstart', -1 ) );
?>

<form action="index.php" method="post" name="adminForm" id="ckadminform" >

<div>
	<img src="components/com_ckforms/images/find.png" /> <?php echo JText::_( COM_CKFORMS_MSG_45); ?>
    ...
    <select id="ckfilterpublished" name="ckfilterpublished" size="1">
		...
		<option value="1" <?php if (JRequest::getVar( 'ckfilterpublished', '0') == '1') { echo 'selected="selected"';}?> ><?php echo JText::_( COM_CKFORMS_MSG_39 ); ?></option>	
		<option value="2" <?php if (JRequest::getVar( 'ckfilterpublished', '0') == '2') { echo 'selected="selected"';}?> ><?php echo JText::_( COM_CKFORMS_MSG_40 ); ?></option>
    </select>
    <input name="ckbtnsearch" type="submit" value="<?php echo JText::_( COM_CKFORMS_MSG_41 ); ?>" />
    <input name="ckbtnreset" id="resetBtn" type="button" value="<?php echo JText::_( COM_CKFORMS_MSG_42 ); ?>" />
</div>
...
<thead>
    <tr>
		...
		<?php 
			echo JText::_( COM_CKFORMS_MSG_39 ).$sortimg;
		?>
        </a>
			</th>	
...
<?php         
 ...
 ?>
    	...
    	<?php 
         ...
         <a href="<?php echo $sortLinkURL; ?>">
		<?php 
			echo JText::_( COM_CKFORMS_MSG_02 ).$sortimg;
		?>
        </a>
			</th>
    	...
    	<?php 
         ...
         <a href="<?php echo $sortLinkURL; ?>">
		<?php 
			echo JText::_( COM_CKFORMS_MSG_44 ).$sortimg;
		?>
        </a>
			</th>
	</tr>			
