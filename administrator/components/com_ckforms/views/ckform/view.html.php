...
class CkformsViewCkform extends JView
{
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(JText::_( COM_CKFORMS_01 ).': <small><small>[ ' . $text.' ]</small></small>' , 'ckform' );
...
$document->addCustomTag('<script type="text/javascript" src="'.JURI::root(true).'/administrator/components/com_ckforms/js/mootabs.js"></script>');		parent::display($tpl);
	}
}
