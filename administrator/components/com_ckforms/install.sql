create table if not exists #__ckforms
(
...
create table if not exists #__ckfields
(
   id                           int(11) not null AUTO_INCREMENT,
   fid                          int(11),
   name                         text,
...
create table if not exists #__ckprofiles
(
   id                           int(11) not null AUTO_INCREMENT,
   formid                       int(11),
   name                        	text,
...
create table if not exists #__ckprofilefields
(
   id                           int(11) not null AUTO_INCREMENT,
   profileid                    int(11),
   fieldid                      text,
