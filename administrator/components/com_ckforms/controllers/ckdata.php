...
class CkformsControllerCkdata extends JController
{
	...
	function export() {
		...
		if ($isIPaddress == true)
		{
			$data .= ";".JText::_( COM_CKFORMS_MSG_02 );
		}
...
exit;
	...
	function publish()
	{
		...
		$link = 'index.php?option=com_ckforms&controller=ckdata&fid='. $fid ;

		JArrayHelper::toInteger( $cid );
		$cids = implode( ',', $cid );

		$query = 'UPDATE #__ckforms_'.$fid
		...
		$this->setMessage( JText::sprintf( $publish ? COM_CKFORMS_MSG_19 : COM_CKFORMS_MSG_20, $n ) );
