...
<h1 class="ckformtitle" <?php echo $this->params->get( 'pageclass_sfx' ); ?>">
<?php	
...
<table class="category ckdatatable <?php if (isset($this->displayBorders) == false || strcmp($this->displayBorders,"1") == 0) {echo "ckdatatableborder";} ?>">

<?php if (isset($this->displayColumnHeader) == false || strcmp($this->displayColumnHeader,"1") == 0)
{
	$sortLink = JRoute::_( 'index.php?option=com_ckforms&controller=ckdata&view=ckformsdata&layout=data&id='.$this->id.'&cid[]='.$this->form->id.'&Itemid='.$this->itemid.'&limitstart='.$this->limit );
