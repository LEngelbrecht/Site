...
<?php	
	...
	$linkback = "index.php?option=com_ckforms&view=ckformsdata&layout=data&controller=ckdata&Itemid=".$this->itemid;
	if ($this->limit < 0)
	{
...
<p>
	<a href="<?php echo $linkback; ?>"><?php echo JText::_( COM_CKFORMS_MSG_18 ); ?> &raquo;</a>
</p>
...
<?php if ($this->form->poweredby == '1') { ?>
	<div id="ckpoweredby" colspan="<?php if ($custominfo == true){?>3<?php } else {?>2<?php }?><?php echo JText::_( '<div id="ckpoweredby"><?php echo JText::_( COM_CKFORMS_MSG_128 ); ?></a></div>' ); ?></a></div>
<?php } ?>
